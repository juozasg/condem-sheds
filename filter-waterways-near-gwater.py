...
def main():
    ...
    for feature in waterways:
        ...
        if is_segment_near_water(segments, gwater_data, geotransform, search_distance):
            ...
            # Set the geometry
            # out_feature.SetGeometry(ogr.CreateGeometryFromWkt(feature.wkt))
...
def is_segment_near_water(segments, gwater_data, geotransform, search_distance=30.0):
    # Check each segment
